...
read.table("ncbi_protein_coding_genes.tsv")->gene_list
names(counts)<-c("gene_name", "count")
counts$gene_name %in% gene_list$GeneID
summary(counts$gene_name %in% gene_list$GeneID)
